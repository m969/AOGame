...
namespace EGamePlay
{
    public class BezierComponent : MonoBehaviour
    {
        ...
        //    transform.DOMove(BezierCurve.GetPoint(Progress), 0.3f).OnComplete(DOMoveNext);
        //}
        ...
        //    p[1] = ctrlPoints[segment_index].OutTangent + (float3)p[0];
        //    p[3] = ctrlPoints[segment_index + 1].position;
        //    p[2] = ctrlPoints[segment_index + 1].InTangent + (float3)p[3];
