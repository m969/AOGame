...
namespace ET
{
    public static class BuildAssembliesHelper
    {
        ...
        public static void BuildModel(CodeOptimization codeOptimization, GlobalConfig globalConfig)
        {
            ...
            //Model = "Client.Outer";
            //codes = new List<string>() { "Assets/Codes/Client.Outer/", };
            //BuildAssembliesHelper.BuildMuteAssembly($"{Model}", codes, new[] { Path.Combine(Define.BuildOutputDir, "Game.Model.dll") }, codeOptimization, globalConfig.CodeMode);
            ...
            string[] additionalReferences, CodeOptimization codeOptimization, CodeMode codeMode = CodeMode.Client)
        {
            ...
            if (codeMode == CodeMode.Client)
            {
                ...
                //list.Add($"Library/ScriptAssemblies/{assemblyName}.Code.dll");
