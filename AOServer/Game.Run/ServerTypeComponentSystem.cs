namespace AO
{
    ...
    {
        [ObjectSystem]
        public class ServerTypeComponentAwakeSystem : AwakeSystem<ServerTypeComponent, string>
        {
            protected override void Awake(ServerTypeComponent self, string serverType)
            {
