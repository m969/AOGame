...
namespace ET.Server
{
    ...
    public static class NetInnerComponentSystem
    {
        ...
        {
            //Log.Console($"OnRead {channelId} {message}");
        ...
        {
            EventSystem.Instance.Publish(ETRoot.Root, new NetInnerComponentOnRead() { ActorId = actorId, Message = message });
        }
        ...
        public static Session CreateInner(this NetInnerComponent self, long channelId, IPEndPoint ipEndPoint)
        {
            Session session = self.AddChildWithId<Session, int>(channelId, self.ServiceId);
            session.RemoteAddress = ipEndPoint;
        ...
        public static Session Get(this NetInnerComponent self, long channelId)
        {
            ...
            IPEndPoint ipEndPoint = AO.AOGame.GetAppConfig(channelId).EndPoint;//StartProcessConfigCategory.Instance.Get((int)channelId).InnerIPPort;
