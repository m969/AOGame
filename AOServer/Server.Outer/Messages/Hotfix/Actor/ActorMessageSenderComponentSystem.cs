...
namespace ET.Server
{
    ...
    public static class ActorMessageSenderComponentSystem
    {
        ...
        public static void Send(this ActorMessageSenderComponent self, long actorId, IMessage message)
        {
            ...
            //Log.Console($"ActorMessageSenderComponentSystem processActorId.Process={processActorId.Process} Options.Instance.Process={Options.Instance.Process}");
            if (processActorId.Process == Options.Instance.Process || processActorId.Process == 0)
            {
